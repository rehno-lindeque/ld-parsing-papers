...
%In other words every production rule has at least two tokens on the right-hand side. Then it is clear that $n log(n)$ would bound the number of $reduce$ instructions.
%%%%%%%%%%
