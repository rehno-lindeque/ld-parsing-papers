...
A domain specific language for parsers with delayed derivations is described.
...
Finally an automatic parser generator is described, taking a context-free grammar as input.
\end{abstract}
